...
notifica várias pessoas envolvidas no processo de edição de uma "
que um comentário foi enviado."',
  'emails.submissionDecisionReviewers.subject' => 'Decisão sobre "{$submissionTitle}"',
  'emails.submissionDecisionReviewers.description' => '
notifica os avaliadores de uma submissão que o processo de "
foi concluído. Inclui informações sobre o artigo e a decisão "
além de agradecer pela contribuição."',
  'emails.layoutAck.subject' => 'Agradecimento pelas composições',
  'emails.layoutAck.description' => '
enviada pelo Editor de Seção ao Editor de Layout, agradecendo "
conclusão das composições."',
  'emails.proofreadAuthorRequest.subject' => 'Solicitação de leitura de provas ao autor',
  'emails.proofreadAuthorRequest.description' => '
enviada pelo Editor de Seção ao autor, solicitando que verifique "
trabalho realizado pelo Editor de Layout, com informações sobre acesso "
avisando que somente é possível corrigir erros tipográficos de layout."',
...
enviada pelo Autor ao Editor de Seção, informando a conclusão da "
de Provas."',
  'emails.proofreadAuthorAck.subject' => 'Agradecimento pela leitura de provas pelo autor',
  'emails.proofreadAuthorAck.description' => '
enviada pelo Editor de Seção ao autor, agradecendo a conclusão "
Leitura de Provas."',
  'emails.proofreadRequest.subject' => 'Solicitação de leitura de provas',
  'emails.proofreadRequest.description' => '
enviada pelo Editor de Seção ao Leitor de Provas, solicitando "
verifique o trabalho realizado pelo Editor de Layout e o autor, "
os comentários e alterações solicitadas. É o último momento "
verificar a qualidade do documento e evitar possíveis erros antes da "
',
  'emails.proofreadComplete.subject' => 'Leitura de provas concluída',
  'emails.proofreadComplete.description' => '
enviada pelo Leitor de Provas ao Editor de Seção, informando a "
da Leitura de Provas."',
  'emails.proofreadAck.subject' => 'Agradecimento pela leitura de provas',
  'emails.proofreadAck.description' => '
enviada pelo Editor de Seção ao Leitor de Provas, agradecendo "
trabalho concluído de Leitura de Provas."',
...
enviada pelo Editor de Layout ao Editor de Seção, informando a "
das novas composições, após Leitura de Provas"',
...
enviada pelo Editor de Seção ao Editor de Layout, agradecendo "
conclusão das composições, após a Leitura de Provas"',
);