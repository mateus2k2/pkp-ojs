...
à cobertura geoespacial, cronológica ou histórica, e/ou "
da pesquisa."',
  ...
  'manager.settings.journalDescription' => '
as configurações específicas para a revista (editorial, contato, "
diretrizes, filiação e apoio, categorias e séries)."',
  'manager.settings.publicationDescription' => '
as configurações específicas para o processo de publicação "
gerais, fase de envio do manuscrito, avaliação, estágio "
estágio de produção, modelos de email)."',
  'manager.settings.websiteDescription' => '
as configurações específicas para as páginas do site público "
inicial, a aparência, idiomas)"',
  'manager.settings.distributionDescription' => '
as configurações específicas para o processo de distribuição "
indexação, arquivamento, pagamento, ferramentas de leitura)."',
